...
def read_cmdargs():
    ...
    parser.add_argument('--writestats', '-ws',  help = "write additional stats to file (flag)",                         metavar ="", type = str2bol, default = False,    nargs='?')
    parser.add_argument('--bc_aggbwtime','-aggbt',help = "03: aggregate backward time (flag)",                          metavar ="", type = str2bol, default = True,    nargs='?')

...
def read_cmdargs():
    ...
    parser.add_argument('--cevap_drh',  '-cer', help = "threshold for detection of E using a maximum delta(RH)",        metavar ="", type = float,   default = 100)
    ...
    parser.add_argument('--cheat_drh',  '-chr', help = "threshold for detection of H using a maximum delta(RH)",        metavar ="", type = float,   default = 100)

...
def read_cmdargs():
    ...
    parser.add_argument('--explainp', '-exp',   help = "trajectory-based upscaling of contributions",                   type = str2bol, default = False,    nargs='?')
    parser.add_argument('--upscale', '-ups',    help = "timestep-based upscaling of contributions",                     type = str2bol, default = False,    nargs='?')
